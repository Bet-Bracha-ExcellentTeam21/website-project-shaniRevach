...
public class ProductConfig {
    ...
    CommandLineRunner commandLineRunner(ProductRepository productRepository){
		return args -> {
			Product opera = new Product("opera", "images/opera.html", 20.0);
			productRepository.save(opera);
			Product chocolatePie = new Product("coconut chocolate pie", "images/coconut chocolate pie.html", 15.0);
			productRepository.save(chocolatePie);
			Product chocolateEclair = new Product("chocolate eclair", "images/chocolate eclair.html", 13.0);
